...
<script defer src="<?php echo base_url('resources/js/slider.js'); ?>"></script> 
<script type="text/javascript">
    ...
    <div id="main">
    	<ul>
        	<li><a href="<?php echo site_url('about'); ?>"><img src="<?php echo base_url('resources/images/home_img1.jpg'); ?>" /></a></li>
            <li><a href="<?php echo site_url('join'); ?>"><img src="<?php echo base_url('resources/images/home_img2.jpg'); ?>" /></a></li>
            <li><a href="<?php echo site_url('honor'); ?>"><img src="<?php echo base_url('resources/images/home_img3.jpg'); ?>" /></a></li>
        </ul>
    </div>
